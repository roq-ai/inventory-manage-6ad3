  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience efficiency like never before with Inventory Management System - Streamlining processes, boosting productivity, and cost reduction at your fingertips."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience efficiency like never before with Inventory Management System - Streamlining processes, boosting productivity, and cost reduction at your fingertips.`}
            </Text>
            <Box
